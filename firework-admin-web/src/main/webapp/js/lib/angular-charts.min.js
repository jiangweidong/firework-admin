...
angular.module('angularCharts').directive('acChart', [
   ...
   */
    function link(scope, element, attrs) {
      ...
      prepareConfig();
      var totalWidth = scope.acChartWidth;
      var totalHeight = scope.acChartHeight;
     ...
     */
      ...
      w.bind('resize', function (ev) {
        ...
        resizePromise = $timeout(function () {
          totalWidth = scope.acChartWidth;
          totalHeight = scope.acChartHeight;
          init();
        }, 100);
      });
      ...
      scope.$watch(function () {
        return {
          w: scope.acChartWidth,
          h: scope.acChartHeight
        };
      }, function (newvalue) {
